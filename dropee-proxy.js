...
class DropeeAPIClient {
  ...
  log = (msg, type = "info") => {
    ...
    const logFormat = `${timestamp} | [Account ${this.accountIndex + 1}][${this.proxyIp}] | ${type.toUpperCase()} | ${msg}`;
  ...
  async runAccount() {
    ...
    try {
      ...
      console.log(`=========Account ${this.accountIndex + 1} | ${firstName}|[${proxyIP}] | Take ${timesleep} before starting=============`.green);
